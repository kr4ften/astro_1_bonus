...
filename = ['4.69e9y0.000152m.txt', '4.69e9y0.0152m.txt']
...
# Plot HR-diagram
plt.figure(dpi=300)
plt.plot(10 ** i1DF['logTe'], i1DF['logL'], '.k', label=filename[0][7:-4])
plt.plot(10 ** i2DF['logTe'], i2DF['logL'], '.b', label=filename[1][7:-4])
plt.legend()
